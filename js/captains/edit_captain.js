/**
 * Edit Captain Form JavaScript
 * Handles form validation and interactivity for editing captain
 */
...
(function() {
    ...
    // Fetch form
    const form = document.getElementById('editCaptainForm');
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            if (form.checkValidity()) {
                ...
                const confirmed = confirm(`Bạn có chắc muốn cập nhật thông tin cơ trưởng "${captainName}"?`);
